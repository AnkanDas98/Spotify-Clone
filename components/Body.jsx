      ...
      <div className="flex gap-x-8 absolute min-w-full md:relative ml-6">
        ...
        <div className="w-full pr-11">
          <h2 className="text-white font-bold mb-3">
            {searchResults.length === 0 ? "New Realses" : "Tracks"}
          </h2>
          <div className="space-y-3 border-2 border-[#262626] rounded-2xl p-3 bg-[#0D0D0D] overflow-y-scroll h-[1000px] md:h-96 scrollbar-thin scrollbar-thumb-gray-600 hover:scrollbar-thumb-gray-500 w-[830px] round-scrollbar">
            {searchResults.length === 0
              ? newReleases
