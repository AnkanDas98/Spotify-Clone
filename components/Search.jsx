  ...
  return (
    <div className="max-w-[1150px] bg-[#1a1a1a] rounded-full overflow-hidden border-2 border-[#333] p-1.5 px-5 pr-8 flex items-center">
      ...
      <input
        ...
        className="bg-[#1a1a1a] text-white border-none lg:w-full focus:ring-0 outline-none placeholder-[#fafafa] placeholder:text-sm placeholder:tracking-wide text-xs"
        placeholder="Search..."
      />
